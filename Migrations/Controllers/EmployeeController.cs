...
namespace BenifitCostDemo.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,FullName,Gender,Department,Company")] Employee employee)
        {
        ...
        {
            return _context.dependents.Any(e => e.EmployeeId == id);
        }
    }
}
